      ...
      <section className='flex flex-col gap-2 max-h-[500px] overflow-y-auto'>
        {
          all.reverse().map((period) => {
            ...
            return <article key={id} className={cn('flex gap-2 justify-between font-semibold uppercase text-xs', isActiveOne && 'text-expentrac-800')} >
