  ...
  return <div className='block md:hidden'>
    ...
    <aside className={twMerge('flex flex-col gap-6 p-8 fixed z-50 h-screen w-screen bg-slate-900 top-0 left-0 shadow-md items-end transition-[left]', isOpen ? 'left-0' : 'left-[100%]')}>
      ...
      <nav className='flex flex-col gap-4 mt-8'>
        <a href='/' className='text-slate-300 text-4xl uppercase tracking-wider text-right'>Home</a>
        <a href='/blog' className='text-slate-300 text-4xl uppercase tracking-wider text-right'>Blog</a>
        <a href='/pricing' className='text-slate-300 text-4xl uppercase tracking-wider text-right'>Pricing</a>
        <a href='/team' className='text-slate-300 text-4xl uppercase tracking-wider text-right'>Team</a>
      </nav>
      <Separator />
