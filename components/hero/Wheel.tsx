...
export const Wheel = () => {
  return <div className='
    ...
    <Image src={ImgCoin} placeholder='blur' alt='coins' className='absolute h-full w-full inset-0 bg-cover opacity-20 animate-spin-slowest saturate-0' />
    ...
    <div className='h-4/6 aspect-square rounded-full border border-slate-200/50 bg-slate-700 absolute shadow-bloom-md overflow-hidden -translate-x-5'>
      <Image src={ImgVods} placeholder='blur' alt='coins' className='absolute h-full w-full inset-0 bg-cover saturate-0 opacity-25 animate-spin-slower' />
    </div>
    ...
    <div className='h-2/6 aspect-square rounded-full border border-slate-400/50 absolute shadow-bloom-md overflow-hidden bg-slate-800 -translate-x-10'>
      <Image src={ImgFinance} placeholder='blur' alt='coins' className='absolute h-full w-full inset-0 bg-cover saturate-0 opacity-25 animate-spin-slow' />
    </div>
  </div>
}
