export const Wheel = () => {
  return <div className='absolute h-screen md:h-[120vh] md:-top-[10vh] aspect-square left-1/4 md:left-1/2 lg:left-1/3 rounded-full border border-slate-200/40 justify-center items-center overflow-hidden hero-perspective shadow-bloom bg-slate-600 hidden sm:flex'>
